...
class MovieDB {
  ...
  void _onCreate(Database db, int newVersion) async {
    await db.execute(
        'CREATE TABLE movie(id INTEGER PRIMARY KEY, title TEXT, tagline TEXT, poster_path TEXT,backdrop_path TEXT,vote_average DOUBLE, overview TEXT,original_language TEXT, release_date TEXT, homepage TEXT, popularity TEXT, production_companies TEXT,revenue INTEGER,original_title TEXT,production_countries TEXT, runtime TEXT,status TEXT, vote_count INTEGER)');
  }
